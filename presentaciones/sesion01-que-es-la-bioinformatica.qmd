...
- Exámenes institucionales: 7–18 de diciembre tengo que confirmar si se
  recorrieron por lo del examen de ingreso

## Cómo trabajamos

- S**itio del curso**: [jerolon.github.io/Bioinformatica_I_2026](#0)
  - Realmente es el repositorio de fuentes y temas, calendario, y
...
- Las entregas van en **su repositorio git** que crearemos hoy
...
- ¿Exámenes cortos por unidad y/o un examen final?
- ¿Proyecto temático por unidad o un proyecto final con presentaciones
  en diciembre?
...
1.  La moldeada por cuellos de botella históricos y presentes: un
    **diluvio de datos**, escasez o abundancia de software, cómputo,
    almacenamiento, etc.
...
- Estas se corresponden con lo que se pregunta Cory Doctorow:
  ...
  ordeal, while others delight in the ways that AI is changing their
...
## Libro para el módulo de alineamientos y algoritmos (octubre)
...
- No está en biblioteca pero tienen acceso en
  <https://cogniterra.org/course/868/promo> o
  <https://cogniterra.org/join-class/e8e47fb8a8f8fc06ed29bb0e772223ba52aebdb5>
  confirmen y avísenme si tienen acceso (hay que hacer cuenta en
  Cogniterra).
